            ...
            <form className={classes.authForm}>
                <div className={classes.authFormContent}>
                    ...
                    <div className="d-grid gap-2 mt-5">
                        <button type="submit" className={`btn btn-primary ${classes.btnColor}`} onClick={()=>{navigate('/dashboard')}}>
                            Submit
                        </button>
                    </div>
                            ...
                            <div className="col-md-12">
                                <div className="form-group mt-3">
                                    ...
                                    <input
                                        ...
                                        className="form-control mt-1"
                                        accept="image/*"
                                        onChange={(e) => setSignUpForm({ ...signUpForm, profilePicture: e.target.files[0] })}
                                    />
                                </div>
                            </div>
                        </div>
